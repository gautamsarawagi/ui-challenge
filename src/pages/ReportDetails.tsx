...
import { IEndpoint, ReportDetailsResultProps } from "../types";
import {
  CheckCircleSolid,
  ChevronRight,
  XCircleSolid,
...
export function ReportDetails() {
  ...
  return (
    <div>
      ...
      <br />
      <input
        className="w-full text-black border-2 border-gray-400 placeholder-gray-300 rounded-md focus:border-purple-800 p-1 outline-none"
        type="search"
        onChange={onChange}
